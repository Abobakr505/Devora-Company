...
import { getProjects } from "../../data/projectsApi.js";
      ...
      <div className="container-devora relative z-10">
        ...
        {loading && (
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            {[0, 1].map((i) => (
              <div
                key={i}
                className="h-[420px] rounded-[2rem] border border-white/[0.06] bg-white/[0.02] animate-pulse"
              />
            ))}
          </div>
        )}
        ...
        {!loading && projects.length === 0 && (
          <p className="text-sm text-mist-600">
            {t.projects.empty ?? "لا توجد مشاريع منشورة حاليًا."}
          </p>
        )}
